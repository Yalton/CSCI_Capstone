...
class interface():
    ...
    def __init__(self):
        ...
        file_exists = exists('userdata.txt')
    ...
    def view_request(self):
        if self.giveninfo == "False":
            ...
            label = Label(window, text='Viewing previous requests', font=(
                "Arial", 15), fg='white', bg='#666666', height=2, width=20)
    ...
    def create_request(self):
        if self.giveninfo == "False":
            ...
            def get_manufacturer_input():
                requestitem.manufacturer = inputmanufactuer.get(
                    "1.0", "end-1c")
                manufactuerinputlabel2.config(
                    text="Email is now: " + requestitem.manufacturer)

            def get_sku_input():
                requestitem.SKU = inputsku.get("1.0", "end-1c")
                skuinputlabel2.config(
                    text="Shipping Address is now: " + requestitem.SKU)

            def get_release_input():
                requestitem.release = inputrelease.get("1.0", "end-1c")
                releaseinputlabel2.config(
                    text="Billing Address is now: " + requestitem.release)

            def get_desiredprice_input():
                requestitem.desiredprice = inputdesiredprice.get(
                    "1.0", "end-1c")
                desiredpriceinputlabel2.config(
                    text="CCfile Location is now: " + requestitem.desiredprice)

            def get_maxprice_input():
                requestitem.maxprice = inputmaxprice.get("1.0", "end-1c")
                maxpriceinputlabel2.config(
                    text="Spendlimit is now: " + requestitem.maxprice)
            ...
            window.configure(background="#666666")  # Set background color
            window.geometry("676x856")  # Set size of window
            label = Label(window, text='Creating a new request', font=(
                "Arial", 15), fg='white', bg='#666666', height=2, width=20)
            label.place(relx=0.5, rely=0, anchor=N)
            # Create Horizontal seperator bar
            separator1 = ttk.Separator(window, orient='horizontal')
            ...
            nameinputlabel = Label(window, text='Name', font=(
                "Arial", 10), fg='white', bg='#666666', height=2, width=8)
            ...
            enterbutton = tk.Button(
                window, text="_/", command=lambda: get_name_input())
            enterbutton.place(relx=0.9, rely=0.1)
            nameinputlabel2 = Label(window, text='', font=(
                "Arial", 10), fg='white', bg='#666666', height=2, width=20)
            nameinputlabel2.place(relx=0.35, rely=0.15)

            manufactuerinputlabel = Label(window, text='Manufactuer', font=(
                "Arial", 10), fg='white', bg='#666666', height=2, width=8)
            ...
            enterbutton2 = tk.Button(
                window, text="_/", command=lambda: get_manufacturer_input())
            enterbutton2.place(relx=0.9, rely=0.2)
            manufactuerinputlabel2 = Label(window, text='', font=(
                "Arial", 10), fg='white', bg='#666666', height=2, width=20)
            manufactuerinputlabel2.place(relx=0.35, rely=0.25)

            skuinputlabel = Label(window, text='SKU', font=(
                "Arial", 10), fg='white', bg='#666666', height=2, width=14)
            skuinputlabel.place(relx=0.1, rely=0.3)
            inputsku = tk.Text(window, height=2, width=40)
            inputsku.place(relx=0.4, rely=0.3)
            enterbutton3 = tk.Button(
                window, text="_/", command=lambda: get_sku_input())
            enterbutton3.place(relx=0.9, rely=0.3)
            skuinputlabel2 = Label(window, text='', font=(
                "Arial", 10), fg='white', bg='#666666', height=2, width=20)
            skuinputlabel2.place(relx=0.45, rely=0.35)

            releaseinputlabel = Label(window, text='Release Date', font=(
                "Arial", 10), fg='white', bg='#666666', height=2, width=14)
            ...
            enterbutton4 = tk.Button(
                window, text="_/", command=lambda: get_release_input())
            enterbutton4.place(relx=0.9, rely=0.4)
            releaseinputlabel2 = Label(window, text='', font=(
                "Arial", 10), fg='white', bg='#666666', height=2, width=20)
            releaseinputlabel2.place(relx=0.45, rely=0.45)

            desiredpriceinputlabel = Label(window, text='Desired Price', font=(
                "Arial", 10), fg='white', bg='#666666', height=2, width=14)
            ...
            enterbutton5 = tk.Button(
                window, text="_/", command=lambda: get_desiredprice_input())
            enterbutton5.place(relx=0.9, rely=0.5)
            desiredpriceinputlabel2 = Label(window, text='', font=(
                "Arial", 10), fg='white', bg='#666666', height=2, width=20)
            desiredpriceinputlabel2.place(relx=0.45, rely=0.55)

            maxpriceinputlabel = Label(window, text='Max Price', font=(
                "Arial", 10), fg='white', bg='#666666', height=2, width=14)
            ...
            enterbutton5 = tk.Button(
                window, text="_/", command=lambda: get_maxprice_input())
            enterbutton5.place(relx=0.9, rely=0.6)
            maxpriceinputlabel2 = Label(window, text='', font=(
                "Arial", 10), fg='white', bg='#666666', height=2, width=20)
            maxpriceinputlabel2.place(relx=0.35, rely=0.65)

            createrequest = tk.Button(
                window, text="Create Request", command=lambda: confirm_request())
            createrequest.place(relx=0.09, rely=0.7)
            createrequestlabel = Label(window, text='', font=(
                "Arial", 10), fg='white', bg='#666666', height=2, width=20)
    ...
    def cancel_request(self):
        if self.giveninfo == "False":
            ...
            window.configure(background="#666666")  # Set background color
            window.geometry("676x856")  # Set size of window
            label = Label(window, text='Cancelling a request', font=(
                "Arial", 15), fg='white', bg='#666666', height=2, width=20)
            label.place(relx=0.5, rely=0, anchor=N)
            # Create Horizontal seperator bar
            separator1 = ttk.Separator(window, orient='horizontal')
    ...
    def input_information(self):
        ...
        def get_saddr_input():
            ...
            saddrinputlabel2.config(
                text="Shipping Address is now: " + self.saddr)

        def get_baddr_input():
            self.baddr = inputbaddr.get("1.0", "end-1c")
            baddrinputlabel2.config(
                text="Billing Address is now: " + self.baddr)

        def get_ccfile_input():
            self.ccfile = inputccfile.get("1.0", "end-1c")
            ccfileinputlabel2.config(
                text="CCfile Location is now: " + self.ccfile)

        def get_spendlimit_input():
            self.spendlimit = inputspendlimit.get("1.0", "end-1c")
            spendlimitinputlabel2.config(
                text="Spendlimit is now: " + self.spendlimit)
        ...
        window.configure(background="#666666")  # Set background color
        window.geometry("676x856")  # Set size of window
        label = Label(window, text='Inputting user information', font=(
            "Arial", 15), fg='white', bg='#666666', height=2, width=20)
        label.place(relx=0.5, rely=0, anchor=N)
        # Create Horizontal seperator bar
        separator1 = ttk.Separator(window, orient='horizontal')
        ...
        enterbutton5 = tk.Button(
            window, text="_/", command=lambda: get_spendlimit_input())
        enterbutton5.place(relx=0.9, rely=0.6)
        spendlimitinputlabel2 = Label(window, text='', font=(
            "Arial", 10), fg='white', bg='#666666', height=2, width=20)
        spendlimitinputlabel2.place(relx=0.35, rely=0.65)

        confirm = tk.Button(window, text="Confirm Information",
                            command=lambda: confirm_request())
        confirm.place(relx=0.09, rely=0.7)
        confirmlabel = Label(window, text='', font=(
            "Arial", 10), fg='white', bg='#666666', height=2, width=20)
    ...
    def settings(self):
        ...
        window.configure(background="#666666")  # Set background color
        window.geometry("676x856")  # Set size of window
        label = Label(window, text='Settings', font=("Arial", 15),
                      fg='white', bg='#666666', height=2, width=20)
        label.place(relx=0.5, rely=0, anchor=N)
        # Create Horizontal seperator bar
        separator1 = ttk.Separator(window, orient='horizontal')
        separator1.place(relx=0, rely=0.04, relwidth=1, relheight=0.005)
    ...
    def error_window(self):
        ...
        window.configure(background="#666666")  # Set background color
        window.geometry("676x856")  # Set size of window
        label = Label(window, text='Error', font=("Arial", 15),
                      fg='white', bg='#666666', height=2, width=20)
        label.place(relx=0.5, rely=0, anchor=N)
        # Create Horizontal seperator bar
        separator1 = ttk.Separator(window, orient='horizontal')
        ...
        separator2 = ttk.Separator(window, orient='vertical')
        separator2.place(relx=0.05, rely=0.04, relwidth=0.005, relheight=1)
        errorlabel = Label(window, text='', font=(
            "Arial", 10), fg='white', bg='#666666', height=2, width=50)
